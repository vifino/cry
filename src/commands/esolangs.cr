...
#	alias WTF = (( -> Nil) | ( -> Array((String | Int32))) | ( -> (String | Int32)) | ( -> Array(Fiber)) | ( -> (Array(Fiber) | Array(String))) | ( -> (Nil | Bool)) | ( -> Array(String)) | ( -> (Array(Fiber) | Array(String))))
#
#	def pop
...
#	end
#
#	def addword(name : String, word : WTF)
...
#		exprs = parse_args(expression)
#		addword name.to_s, ->{ parse(exprs)}
#		@word = [] of T
#	end
#
...
#		}
#		@dictionary = @dictionary as Hash(String, WTF)
#	end
#
